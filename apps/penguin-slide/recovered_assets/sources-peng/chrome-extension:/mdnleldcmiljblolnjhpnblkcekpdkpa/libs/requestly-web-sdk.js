...
var Requestly = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    exports.StorageEventType = void 0;
    (function (StorageEventType) {
        StorageEventType["INITIAL_STORAGE_VALUE"] = "initialStorageValue";
        StorageEventType["KEY_UPDATE"] = "keyUpdate";
    })(exports.StorageEventType || (exports.StorageEventType = {}));

    class StorageClass {
        storageListeners = {
            [exports.StorageType.LOCAL]: null,
            [exports.StorageType.SESSION]: null,
        };
        initStorageCapture(storageType) {
            this.captureInitialStorageDump(storageType);
            window.addEventListener('storage', this.captureStorageEvent);
        }
        startCapturingStorage(storageType, listener) {
            this.storageListeners[storageType] = listener;
            this.initStorageCapture(storageType);
        }
        stopCapturingStorage() {
        ...
        captureInitialStorageDump(storageType) {
            const storage = storageType === exports.StorageType.LOCAL ? localStorage : sessionStorage;
            Object.keys(storage).forEach((key) => {
                ...
                const storageEvent = {
                    ...
                    key,
                    value,
                    eventType: exports.StorageEventType.INITIAL_STORAGE_VALUE,
                    storageType,
                };
                this.notifyListeners(storageEvent);
            });
        }
        captureStorageEvent = (event) => {
            const storageEvent = {
                timestamp: Date.now(),
                key: event.key,
                eventType: exports.StorageEventType.KEY_UPDATE,
                oldValue: event.oldValue,
                newValue: event.newValue,
                storageType: event.storageArea === localStorage ? exports.StorageType.LOCAL : exports.StorageType.SESSION,
            };
            this.notifyListeners(storageEvent);
        };
    ...
    (function (RQSessionEventType) {
        ...
        RQSessionEventType["STORAGE"] = "storage";
    ...
    class SessionRecorder {
        ...
        start() {
            ...
            if (this.#options.localStorage) {
                Storage.startCapturingStorage(exports.StorageType.LOCAL, this.#addStorageEvent);
            }
            if (this.#options.sessionStorage) {
                Storage.startCapturingStorage(exports.StorageType.SESSION, this.#addStorageEvent);
            }
        }
        stop() {
            this.#stopRecording?.();
        ...
        getSession() {
            ...
            Object.values(exports.RQSessionEventType).forEach((eventType) => {
                if (eventType === exports.RQSessionEventType.STORAGE) {
                    events[exports.RQSessionEventType.STORAGE] = {
                        [exports.StorageType.LOCAL]: this.#lastTwoSessionEvents[0][exports.RQSessionEventType.STORAGE][exports.StorageType.LOCAL].concat(this.#lastTwoSessionEvents[1][exports.RQSessionEventType.STORAGE][exports.StorageType.LOCAL]),
                    };
                    events[exports.RQSessionEventType.STORAGE][exports.StorageType.SESSION] = this.#lastTwoSessionEvents[0][exports.RQSessionEventType.STORAGE][exports.StorageType.SESSION].concat(this.#lastTwoSessionEvents[1][exports.RQSessionEventType.STORAGE][exports.StorageType.SESSION]);
                }
                else {
        ...
        #addStorageEvent = (event) => {
            const previousStorageEvents = this.#lastTwoSessionEvents[1][exports.RQSessionEventType.STORAGE];
        ...
        #getEmptySessionEvents() {
            ...
            Object.values(exports.RQSessionEventType).forEach((eventType) => {
                if (eventType === exports.RQSessionEventType.STORAGE) {
                    Object.values(exports.StorageType).forEach((storageType) => {
                        emptySessionEvents[exports.RQSessionEventType.STORAGE] = {
                            ...emptySessionEvents[exports.RQSessionEventType.STORAGE],
                            [storageType]: [],
                        };
                    });
